...
import { Button, Card, FieldError, Input, Label, ListBox, Modal, Surface, TextArea, TextField,Select } from "@heroui/react";
...
const EditModel = ({destination}) => {
  ...
  return (
    <Modal>
         ...
         <Button className=" bg-white font-bold text-black variant  "> <BiEdit></BiEdit> Edit</Button>
       
       {/* <div className="flex justify-end">
         <Button className=" bg-white font-bold text-black variant  "> <FiDelete></FiDelete> Delete</Button>
       </div> */}
      <Modal.Backdrop>
